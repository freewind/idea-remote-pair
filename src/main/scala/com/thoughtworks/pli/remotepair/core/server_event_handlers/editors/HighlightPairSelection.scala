...
import com.thoughtworks.pli.remotepair.idea.editor.{RemoveOldHighlighters, NewHighlights}
import com.thoughtworks.pli.remotepair.idea.file.GetDocumentLength

...
class MyVirtualFileAdapter(currentProject: IdeaProjectImpl, handleIdeaEvent: HandleIdeaEvent, myPlatform: MyPlatform, myClient: MyClient, logger: PluginLogger, writeToProjectFile: WriteToProjectFile, isSubPath: IsSubPath, ideaFactories: IdeaFactories)

...
import com.thoughtworks.pli.remotepair.idea.core.{WriteToProjectFile, GetMyClientName, ClientVersionedDocuments}
import com.thoughtworks.pli.remotepair.idea.utils.RunWriteAction

// FIXME add test
class HandleDocumentSnapshotEvent(clientVersionedDocuments: ClientVersionedDocuments, logger: Logger, getMyClientName: GetMyClientName, writeToProjectFile: WriteToProjectFile, runWriteAction: RunWriteAction) {

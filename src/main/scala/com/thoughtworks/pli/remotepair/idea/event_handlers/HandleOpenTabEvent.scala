...
class HandleOpenTabEvent(getFileByRelative: GetFileByRelative, openTab: OpenFileInTab, tabEventsLocksInProject: TabEventsLocksInProject, getCurrentTimeMillis: GetCurrentTimeMillis, isFileOpened: IsFileOpened) {

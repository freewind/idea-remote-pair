package com.thoughtworks.pli.remotepair.idea.core.editors
...
import com.thoughtworks.pli.remotepair.idea.core.{GetDocumentContent, GetTextEditorsOfPath, NewHighlights, RemoveOldHighlighters}

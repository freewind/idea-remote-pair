...
trait Module extends UtilsModule {
  ...
  lazy val myPlatform = new IdeaIdeImpl(currentProject)
  ...
  lazy val scrollToCaretInEditor = new ScrollToCaretInEditor()
  lazy val drawCaretInEditor = new DrawCaretInEditor()
  ...
  lazy val handleIdeaFileEvent = new HandleIdeaFileEvent(currentProject, myPlatform, myClient, logger, clientVersionedDocuments, writeToProjectFile)
  lazy val handleCaretChangeEvent = new HandleCaretChangeEvent(myClient, logger, getDocumentContent, getCaretOffset)
  lazy val handleDocumentChangeEvent = new HandleDocumentChangeEvent(myPlatform, myClient, newUuid, logger, clientVersionedDocuments)
  ...
  lazy val myVirtualFileAdapterFactory: MyVirtualFileAdapter.Factory = () => new MyVirtualFileAdapter(currentProject: IdeaProjectImpl, handleIdeaEvent: HandleIdeaEvent, myPlatform: MyIde, myClient: MyClient, logger: PluginLogger, writeToProjectFile: WriteToProjectFile, isSubPath: IsSubPath, ideaFactories: IdeaFactories)

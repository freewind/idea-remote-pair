...
trait Module extends UtilsModule {
  ...
  lazy val handleDocumentChangeEvent = new HandleDocumentChangeEvent(myPlatform, myClient, publishCreateDocumentEvent, newUuid, logger, clientVersionedDocuments)

...
trait Module extends UtilsModule {
  ...
  lazy val writeToProjectFile = new WriteToProjectFile(currentProject)
  ...
  lazy val handleIdeaFileEvent = new HandleIdeaFileEvent(currentProject, myIde, myClient, logger, clientVersionedDocuments, writeToProjectFile)
  ...
  lazy val myVirtualFileAdapterFactory: MyVirtualFileAdapter.Factory = () => new MyVirtualFileAdapter(currentProject, handleIdeaEvent, myIde, myClient, logger, writeToProjectFile, isSubPath, ideaFactories)

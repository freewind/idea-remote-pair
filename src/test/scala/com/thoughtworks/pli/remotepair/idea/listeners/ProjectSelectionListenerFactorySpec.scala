...
class ProjectSelectionListenerFactorySpec extends Specification with Mockito with MocksModule {
  ...
  override lazy val projectSelectionListenerFactory = new ProjectSelectionListenerFactory(publishEvent, pluginLogger, inWatchingList, getRelativePath, getSelectionEventInfo, isReadonlyMode)

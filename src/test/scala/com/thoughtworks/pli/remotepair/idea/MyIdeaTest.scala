...
// */
//class MyIdeaTest(currentProject:RichProject) extends LightPlatformCodeInsightTestCase with InvokeLater with PublishEvent {
//
...
//        apply(CreateProjectRequest("ttt", "client111"))
//      }

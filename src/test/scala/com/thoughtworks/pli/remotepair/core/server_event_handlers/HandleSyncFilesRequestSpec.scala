...
//import com.thoughtworks.pli.remotepair.core.server_event_handlers.syncfiles.HandleSyncFilesRequest
...
//
//  val (file2, file3, file4) = (mock[MyFile], mock[MyFile], mock[MyFile])
//
